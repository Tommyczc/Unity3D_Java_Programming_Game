        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    DreamOSEditorHandler.DrawPropertyCW(notificationDescription, customSkin, "Description", 0);

                    if (enablePopupNotification.boolValue == true)
                        DreamOSEditorHandler.DrawPropertyCW(popupDescription, customSkin, "Popup Description", 0);
