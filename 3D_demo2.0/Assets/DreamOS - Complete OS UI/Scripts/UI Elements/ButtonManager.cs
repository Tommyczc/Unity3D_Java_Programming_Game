...
namespace Michsky.DreamOS
{
    public class ButtonManager : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler
    {
        ...
        void OnEnable()
        {
            ...
            if (buttonVar != null) { StartCoroutine("FixLayout"); }
        }
        ...
        public void UpdateUI()
        {
            ...
            if (enableIcon == true) { normalIcon.sprite = buttonIcon; highlightedIcon.sprite = buttonIcon; }
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            if (enableButtonSounds == true && useClickSound == true && buttonVar.interactable == true)
        ...
        IEnumerator FixLayout()
        {
            ...
            LayoutRebuilder.ForceRebuildLayoutImmediate(buttonVar.GetComponent<RectTransform>());
        }
    }
}