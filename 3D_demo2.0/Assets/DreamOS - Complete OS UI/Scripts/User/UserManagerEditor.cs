        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    DreamOSEditorHandler.DrawProperty(bootScreen, customSkin, "Boot Screen");
                ...
                case 2:
                    ...
                    {
                        EditorGUILayout.HelpBox("Disable User Creation is enabled. You can change the default user settings by switching to the first tab.", MessageType.Info);
