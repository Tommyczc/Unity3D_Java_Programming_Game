...
namespace Michsky.DreamOS
{
    public class ResetPassword : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            if (userManager.disableUserCreating == false && PlayerPrefs.GetString("DreamOS" + "User" + "SecQuestion") != "")
            {
                securityQuestion.text = PlayerPrefs.GetString("DreamOS" + "User" + "SecQuestion");
                tempSecAnswer = PlayerPrefs.GetString("DreamOS" + "User" + "SecAnswer");
            }
        ...
        public void ChangePassword()
        {
            ...
            {
                PlayerPrefs.SetString("DreamOS" + "User" + "Password", newPassword.text);
