...
namespace Michsky.DreamOS
{
    public class SetupManager : MonoBehaviour
    {
        ...
        public TMP_InputField passwordRetypeInput;
        public Button infoContinueButton;
        public Button privacyContinueButton;
        public Animator errorMessageObject;
        public TextMeshProUGUI errorMessageText;

        // Settings
        public int currentPanelIndex = 0;
        public bool enableBackgroundAnim = true;
        [TextArea] public string firstNameLengthError;
        [TextArea] public string lastNameLengthError;
        [TextArea] public string passwordLengthError;
        [TextArea] public string passwordRetypeError;
