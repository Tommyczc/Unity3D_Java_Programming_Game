...
namespace Michsky.DreamOS
{
    public class MessagingManager : MonoBehaviour
    {
        ...
        public void CreateStoredMessage(int layoutIndex, string message, string time, bool isSelf)
        {
            ...
            if (isSelf == true) { msgObj = Instantiate(chatMessageSent, new Vector3(0, 0, 0), Quaternion.identity) as GameObject; }
            else { msgObj = Instantiate(chatMessageRecieved, new Vector3(0, 0, 0), Quaternion.identity) as GameObject; }
